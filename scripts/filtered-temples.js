...
const temples = [
  ...
  },
  {
    ...
    area: 48100,
    imageUrl:
    "https://content.churchofjesuschrist.org/templesldsorg/bc/Temples/photo-galleries/campinas-brazil/800x500/campinas-brazil-temple-1030031-wallpaper.jpg"
  },
  {
...
createTempleCard(temples.filter(temple => {const yeart = parseInt(temple.dedicated.split(",")[0]);
	return yeart >= 2000})
)});
